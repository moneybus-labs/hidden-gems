...
const chaechoriData = [
    {
        category: "1. 멘탈 관리 및 메타인지 (투자자 자기 객관화)",
        items: [
            "채권은 금리의 역수인데 무슨 당연한 것을 위기라고 생각하십니까 금리 오르면 채권 빠지고 금리 내리면 채권 오르는데... 당연한 방향으로 안 움직이는 게 위기지...",
            "파란책에 다 나오는 내용입니다 주가가 변동하는 걸 못 견디는 분들은 주식을 안 하는 게 좋습니다.",
            "결국 남이 좋다는 걸 했다가 내가 못 견디는 거잖아요? 주식부자 취지도 그런 겁니다 너 자산을 알라는 거거든요 나는 어떤 투자자인가 어떤 사람인가",
            "이런 변동에 취약한 사람이면 아예 안 하는 게 낫죠",
            "여튼 11불이 9불 갔다고 멘탈이 나가시는 분들은 그만큼 가격에 약하다는 증거이므로 차제에 자기를 이해하는 계기로 삼으시고, 직투를 지양하고 액티브로 위탁을 하는 방식으로 대응하시는 게 나을 거 같습니다.",
            "가격이 내려도 대범해져야한다 이게 아니라, 가격 변동이 사람에게 주는 영향은 사람별로 다르기 때문입니다.",
            "결국 투자는 “나를 알아가는 과정”이고 나를 아는 사람에게는 투자가 쉬운 법이고 나를 모르는 상태에서 남의 방법을 따르기만 하는 분들에게는 투자가 불편한 법입니다. 그러니 상품 공부가 아니라... 나라는 사람이 어떤지를 배우는 계기가 되었으면 좋겠네요",
            "주식 안 합니다 이런 사람도 메타인지가 되신 분입니다 자기랑 주식이 안 맞다는 걸 아시는 거죠"
        ]
    },
    {
        category: "2. 투자 태도와 자가 주도 학습",
        items: [
            "둘째 가격 변동에 휘둘리는 근본적인 이유는 모르면 차라리 아예 맡기라고 했잖아요 공부하지 말고 우린 공부할 시간이 없으니까요",
            "자기가 뭘 몰라서 왕왕 거리는 걸 무슨 세상 위기 온 것처럼 말하면서 부끄럼도 없냐고요 책에도 다 있고 매번 해왔던 말인데...",
            "누구는 8불 오면 더 사야지 누구는 10불에서 9불 가니까 후회로 가득하고... 늘 말하지만 사람들은 오를 때는 공부 안 해요. 내려야 즉 물려야 공부하지...",
            "시장이 평온하면 내가 잘난 거고 잘 산 거고 가격이 하락하면 문제가 발생한 거니까, 뭐가 잘못됐지? 라고 하면서 무언가를 찾아내려고 하죠",
            "그때 아 내가 모르고 샀구나 공부가 적었구나로 가는 사람이 있고 아 내가 누구/무엇 때문에 샀지 저놈 나쁜 놈 이렇게 외부로 돌리는 사람이 있습니다.",
            "쉴 때 주식 공부 해두면 좋잖아요 그래야 살 때 사지...",
            "그리고 아직도 뭘 해야 될지 판단이 스스로 안 서면 이번 주 요약글 팬딩에 올라가면 개념 정리를 좀 해보시고 기출만 풀다가는 응용 나오면 다 틀릴 텐데"
        ]
    },
    {
        category: "3. 액티브 펀드 및 대안 투자 활용",
        items: [
            "그럼 직투 말고 액티브 하라고 말씀드린 건데 타플배나 코배성 같은 액티브도 있잖아요? 배당 수익률은 적지만 포트를 매니저가 매니징하고 6%는 주니까 대안이 될 수 있죠",
            "액티브는 펀드니까 알아서 그걸 해주죠 펀드 내 개별 종목들 순환을 하잖아요 매니저들이 개인이 할 이유가 없죠",
            "머니버스의 기본은 퇴직연금이고 저는 퇴직연금은 늘 풀투자를 유지합니다 액티브로만 채웠고요",
            "투자를 해두면 여튼 조정장에 내리는 건 동일한데 연금처럼 20년 묶을 거면 몰라도 조정 아니고 하락이 오면 피할 줄은 알아야 하니, 맡기더라도 시장은 읽어야 합니다 펀드는 결국 다 매수니까요",
            "패시브 넣을 게 뭐 있습니까 물론 정답은 없습니다 하고픈 거 하시고 스트레스 받지 마세요"
        ]
    }
];
