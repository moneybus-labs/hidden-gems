...
const bentoData = [
    ...
    },
    {
        id: 18,
        icon: '💸',
        title: '세금에 매몰되지 마라<br><span style="font-size: 0.75em; opacity: 0.8;">(절세에 매몰되면 성장을 놓치게된다)</span>',
        cardTitle: '세금에 매몰되지 마라',
        logic: '성장 우선주의',
        detail: '해외주식 양도세, 금융종합소득세 등 과세 한도에 지나치게 집착하여 투자 원금이나 유동성을 묶어버리면, 정작 중요한 시기에 확실한 성장 기회를 놓칠 수 있습니다. 세금을 조금 더 내더라도 본질적인 수익률과 성장에 집중하는 것이 먼저입니다.',
        bgClass: '',
        gridClass: ''
    },
    {
    ...
    },
    {
        id: 19,
        icon: '🤫',
        title: '주식으로는 돈 벌었다고 가족외에는 절대 알리지 말라<br><span style="font-size: 0.75em; opacity: 0.8;">(똥파리들이 꼬인다. 반대로 채반꿀을 외치자)</span>',
        cardTitle: '주식으로 돈 번 것<br>가족 외엔 알리지 마라',
    ...
    },
    {
        id: 20,
        icon: '🤐',
        title: '쏠게 아니면 수익자랑 말라<br><span style="font-size: 0.75em; opacity: 0.8;">(돈자랑을 하려거든 밥을 사든가, 아니면 조용히 일지에 적어라)</span>',
        cardTitle: '쏠게 아니라면<br>수익자랑 하지 마라',
